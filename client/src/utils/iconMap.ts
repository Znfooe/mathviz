...
import {
  ...
  FunctionSquare, Waves, Grid3X3,
  Sparkles, Volume2, PenTool, Archive, Info, Send, Map,
  ...
  Atom, CircuitBoard, Orbit, Globe, Telescope, Microscope,
  Keyboard, MousePointer, Magnet, Lock, Unlock, Key,
  Filter, GitBranch, GitMerge, GitFork,
  Home, School, Building2, Factory, Landmark, Briefcase, User,
  Calendar, Clock, Timer, History,
  Search, ZoomIn, ZoomOut, Maximize, Minimize, Move,
  ArrowRight, ArrowLeft, ArrowUp, ArrowDown, CornerDownRight,
  Link, Link2Off, ExternalLink, Share2, Copy, Scissors, FileText,
  Image, Video, Music, Film, Camera, Printer, Monitor, Smartphone,
  Database, Server, HardDrive, Wifi, Bluetooth, Battery, Gauge,
  Thermometer, Wind, Umbrella, CloudRain, Snowflake,
  Leaf, Flower2, TreeDeciduous, Bird, Bug, Fish, Rabbit,
  Apple, Banana, Cherry, Grape,
  Paintbrush, Palette, Wand2, PaintBucket, Pencil,
  CircleDot, CircleEqual, CircleDollarSign, CirclePercent,
  CircleAlert, CircleCheck, CircleX, CircleHelp,
  X, Check, Minus, Equal, Percent, PoundSterling, DollarSign, Euro,
  Layers3, Blocks, Group, List, ListOrdered, ListChecks,
  Grid2X2, Grid3X3 as Grid, Table, TableProperties,
  PieChart, BarChart2, LineChart as LineChart2, AreaChart, ScatterChart,
  Network as Network2, Workflow, GitPullRequest,
  ArrowBigRight, ArrowBigUp, ArrowBigDown, ArrowBigLeft, CornerRightDown,
} from 'lucide-react'
